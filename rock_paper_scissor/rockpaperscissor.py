...
button_rock.grid(row=0, column=0, pady=8)
...
button_paper.grid(row=0, column=1, pady=8)
...
button_scissor.grid(row=0, column=2, pady=8)
...
for frame in gif:
    frame_image = Image.fromarray(frame).resize((780, 380))
